...
import shjpg from '../../assets/sh.jpg'
const About = () => {
  return (
      ...
      <div className="about-sections">
        ...
        <div className="about-right">
            <div className="about-para">
                ...
                <p>My passion for frontend development is not only reflected in my extensive experience but in the enthusiasm and dedication I bring to each project.</p>
            </div>
